...
$(document).ready(function () {
  $.ajax({
    type: "GET",
    url: `https://api-generator.retool.com/2IW1Gp/data?_page=${1}&_limit=${31}`,
    ...
    success: function (allData) {
      ...
      for (var i = 0; i < allData.length; i++) {
        $(".posts").append(`  
            ...
            <div class="post my-3">
      <div class="post-heading d-flex align-items-center gap-2">
        <img src="${allData[i].personalImg}" class="user-photo" alt=""><p class="user-name">${allData[i].name}</p><i class="bi bi-gear post-icon"></i>
      </div>
      <p class="post-text">${allData[i].desc}</p>
                      <img class="w-100 h-100" src="${allData[i].postImg}"   alt="">

                      <div class="d-flex  px-4 align-items-center  justify-content-between mt-2 ">
                                 ...
                                 <div class="d-flex gap-3 px-4 text-secondary">
                               ...
                               <div class="post-actions border-top px-4 p-2 d-flex justify-content-between ">
                                 <a href="#" class="mr-3 text-midDark post-btn  flex-grow-1 text-center"><i class="far fa-thumbs-up"></i> Like</a>
                                 <a href="#" class="mr-3 text-midDark post-btn flex-grow-1 text-center"><i class="far fa-comment"></i> Comment</a>
                                 <a href="#" class="mr-3 text-midDark post-btn flex-grow-1 text-center"><i class="fa-solid fa-repeat"></i> Repost</a>
                                 <a href="#" class="text-midDark  post-btn flex-grow-1 text-center"><i class="fas fa-share "></i> Share</a>
                               </div> 
                             </div>
    </div>
    ...
    error: function (r) {
      console.log("Something went wrong!");
          ...
          // <div class="main-content pb-0 rounded-3 border">
          //   <div class="post  ">
          //     <div class="media">
